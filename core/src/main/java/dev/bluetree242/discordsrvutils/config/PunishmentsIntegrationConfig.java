...
public interface PunishmentsIntegrationConfig {
    ...
    @ConfComments("# The Channels to send punishment messages in, add 0 for discordsrv main chat channel.")
    @AnnotationBasedSorter.Order(19)
    Set<Long> channel_ids();

    @ConfKey("send_punishment_messages_to_discord")
    @ConfDefault.DefaultBoolean(true)
    @ConfComments("# Should we send the message of a person punished on discord? Disabling this disabling any messages (even the ones below).")
    @AnnotationBasedSorter.Order(20)
    boolean isSendPunishmentMsgsToDiscord();

    @ConfKey("muted_role")
    @ConfDefault.DefaultLong(0)
    @ConfComments("# The role to give when player is muted. Leave 0 to not sync mutes.")
    @AnnotationBasedSorter.Order(22)
    long mutedRole();

    @ConfKey("banned_role")
    @ConfDefault.DefaultLong(0)
    @ConfComments("# The role to give when player was muted. Will ban if this role id wasn't found.")
    ...
    @ConfComments("# Message to send when a person was Temporary banned. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(40)
    String tempBannedMessage();

    @ConfKey("ip_banned_message")
    @ConfDefault.DefaultString("message:ban")
    @ConfComments("# Message to send when a person was IP banned. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(50)
    String IPBannedMessage();

    @ConfKey("kick_message")
    @ConfDefault.DefaultString("message:kick")
    @ConfComments("# Message to send when a person was kicked. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(55)
    String kick_message();

    @ConfKey("temp_ip_banned_message")
    @ConfDefault.DefaultString("message:ban")
    @ConfComments("# Message to send when a person was Temporary IP banned. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(60)
    String tempIPBannedMessage();

    @ConfKey("muted_message")
    @ConfDefault.DefaultString("message:mute")
    @ConfComments("# Message to send when a person was Muted. Set to blank and we will not send it at all. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(70)
    String mutedMessage();

    @ConfKey("temp_muted_message")
    @ConfDefault.DefaultString("message:mute")
    @ConfComments("# Message to send when a person was Temporary Muted. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(70)
    String tempMutedMessage();

    @ConfKey("warned_message")
    @ConfDefault.DefaultString("message:warn")
    @ConfComments("# Message to send when a person was warned. Set to blank and we will not send it at all.")
    @AnnotationBasedSorter.Order(71)
    String warnedMessage();

    @ConfKey("sync_minecraft_temp_punishments")
    @ConfDefault.DefaultBoolean(true)
    @ConfComments("# Should we sync the temp punishments to discord?")
    ...
    @ConfDefault.DefaultBoolean(true)
    @ConfComments("# Should we send the unpunishments messages on main chat channel?")
    @AnnotationBasedSorter.Order(90)
    boolean isSyncUnpunishmentsMsgWithDiscord();


    @ConfKey("unbanned_message")
    @ConfComments("# Message to send on discord when player is unbanned. Set to blank and we will not send it at all.")
    @ConfDefault.DefaultString("message:unban")
    @AnnotationBasedSorter.Order(100)
    String unbannedMessage();

    @ConfKey("unip_message")
    @ConfComments("# Message to send on discord when player is unip banned. Set to blank and we will not send it at all.")
    @ConfDefault.DefaultString("message:unban")
    @AnnotationBasedSorter.Order(110)
    String unIPBannedMessage();

    @ConfKey("unmuted_message")
    @ConfComments("# Message to send on discord when player is unmuted. Set to blank and we will not send it at all.")
