...
public class Tickets
{
	...
	{
		try(Connection connection = core.getMemoryConnection())
		{
			PreparedStatement last = connection.prepareStatement("DELETE FROM tickets_creating WHERE Channel_id=? AND UserID=?");
